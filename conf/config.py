...
WORLD_LINES: [WorldLine] = [  # y
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 1, DIRECTION_RIGHT, WATER_TUR_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 1, DIRECTION_LEFT, WATER_WOOD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, []),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_RIGHT, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_LEFT, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_RIGHT, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, []),
]
