...
WORLD_LINES: [WorldLine] = [  # y
    ...
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_LEFT, 0.016, REVERSED_ROAD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 0, 1, DIRECTION_RIGHT, 0.020, ROAD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 3, DIRECTION_RIGHT, 0.020, ROAD_ENTITIES),
