...
WORLD_LINES: [WorldLine] = [  # y
    ...
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 3, DIRECTION_LEFT, 0.037,
              REVERSED_WATER_TUR_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 2, DIRECTION_LEFT, 0.035, WATER_WOOD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 1, DIRECTION_RIGHT, 0.035, WATER_WOOD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 3, DIRECTION_RIGHT, 0.035, WATER_TUR_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 0, DIRECTION_NONE, 0, NO_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 1, DIRECTION_RIGHT, 0.025, ROAD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_LEFT, 0.025, REVERSED_ROAD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 0, DIRECTION_NONE, 0, NO_ENTITIES),
...
# AGENT
AGENT_LEARNING_FILE = 'qtable.data'
AGENT_LEARNING_RATE = 1
AGENT_GAMMA = 0.8
