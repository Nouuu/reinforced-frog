...
COMMON_ENTITY_TOKEN = 'O'
FORBIDDEN_WORLD_TOKEN = 'F'
COMMON_WORLD_TOKEN = 'W'
...
AGENT_ENVIRONMENT_TOKENS = {
    CAR_TOKEN: FORBIDDEN_ENTITY_TOKEN,
    TRUCK_TOKEN: FORBIDDEN_ENTITY_TOKEN,
    TURTLE_TOKEN: COMMON_ENTITY_TOKEN,
    REVERSED_CAR_TOKEN: FORBIDDEN_ENTITY_TOKEN,
    REVERSED_TRUCK_TOKEN: FORBIDDEN_ENTITY_TOKEN,
    REVERSED_TURTLE_TOKEN: COMMON_ENTITY_TOKEN,
    EXIT_TOKEN: EXIT_TOKEN,
    ROAD_TOKEN: COMMON_WORLD_TOKEN,
    START_TOKEN: START_TOKEN,
    WALL_TOKEN: FORBIDDEN_WORLD_TOKEN,
    WATER_TOKEN: FORBIDDEN_WORLD_TOKEN,
    WOOD_TOKEN: COMMON_ENTITY_TOKEN,
    GROUND_TOKEN: GROUND_TOKEN,
    EMPTY_TOKEN: COMMON_WORLD_TOKEN
}
...
WORLD_LINES: List[WorldLine] = [  # y
    ...
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 3, DIRECTION_LEFT, 0.012, REVERSED_ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_LEFT, 0.016, REVERSED_ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 0, 1, DIRECTION_RIGHT, 0.020, ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 3, DIRECTION_RIGHT, 0.020, ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 0, DIRECTION_NONE, 0, NO_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 1, DIRECTION_RIGHT, 0.02, ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_LEFT, 0.02, REVERSED_ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 0, DIRECTION_NONE, 0, NO_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_RIGHT, 0.02, ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 1, DIRECTION_LEFT, 0.02, REVERSED_ROAD_ENTITIES, random),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 5, 2, DIRECTION_RIGHT, 0.02, ROAD_ENTITIES, random),
