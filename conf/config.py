...
GROUND_ENTITIES: [WorldEntity] = [ENTITIES[TRUCK_TOKEN], ENTITIES[CAR_TOKEN]]
WATER_TUR_ENTITIES: [WorldEntity] = [ENTITIES[FROG_TOKEN]]
...
WORLD_LINES: [WorldLine] = [  # y
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, 0, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 1, DIRECTION_RIGHT, 0.7, WATER_TUR_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[WATER_TOKEN], 0, 1, DIRECTION_LEFT, 0.7, WATER_WOOD_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, 0, []),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_RIGHT, 0.7, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_LEFT, 0.7, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[ROAD_TOKEN], 1, 1, DIRECTION_RIGHT, 0.7, GROUND_ENTITIES),
    WorldLine(WORLD_WIDTH, WORLD_SCALING, ENTITIES[GROUND_TOKEN], 0, 1, DIRECTION_NONE, 0, []),
]
